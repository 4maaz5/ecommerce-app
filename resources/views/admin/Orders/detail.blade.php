                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Shipped Date" value="{{ $order->shipped_date }}" type="date" name="shipped_date" id="shipped_date" class="form-control">
                            </div>
                            <div class="mb-3">
...
$("#changeOrderStatusForm").submit(function(event){
     ...
     $.ajax({
        url:'{{ route("order.changeStatus",$order->id) }}',
        type:'post',
