                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="short_description" id="description" cols="30" rows="10" class="summernote" placeholder="Short Description"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="shiping_returns" id="description" cols="30" rows="10" class="summernote" placeholder="Short Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
