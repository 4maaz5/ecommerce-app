                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <input class="custom-control-input" type="checkbox" id="track_qty" name="track_qty"   {{ ($product->tract_qty=='yes')?'checked':'' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        @if($categories->isNotEmpty())
                                            ...
                                            <option {{ ($category->name!='')?'selected':'' }} value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <p class="error"></p>
