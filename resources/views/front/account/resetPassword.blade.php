            ...
            <div class="login-form">
                <form action="{{ route('front.processResetPassword') }}" method="post">
                   ...
                   @enderror
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control @error('confirm_password') is-invalid @enderror"  placeholder=" confirm_password" name="confirm_password">
                ...
                <div class="text-center small"> <a href="{{ route('front.login') }}">Click here to login</a></div>
            </div>
        </div>
    </section>
</main>
