                                ...
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        <a href="{{ route('front.products', $product->slug) }}" class="product-img">
                                            @php
                                                $image = DB::table('product__images')
                                            ...
                                            @endphp
                                            <img class="card-img-top" src="{{ URL::to($image) }}" alt="Loading"
                                                style="height: 200px">
                                    ...
                                    <div class="card-body text-center mt-3">
                                        <a class="h6 link"
                                            href="{{ route('front.products', $product->slug) }}">{{ $product->title }}</a>
                            ...
                            <div class="col-md-3">
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        ...
                                        <a onclick="addToWishList({{ $product->id }})" class="whishlist"
                                            data-toggle="modal" data-target="#modalGrid" href="javascript:void(0);"><i
                                                class="far fa-heart"></i></a>


                                        <div class="product-action">
                                            {{-- <a class="btn btn-dark" href="javascript:void(0)" data-toggle="modal"
                                                data-target="#modalGrid" onclick="addToCart({{ $product->id }})">
                                                <i class="fa fa-shopping-cart"></i> Add To Cart
                                            </a> --}}
                                            ...
                                            @if ($product->qty > 0)
                                                ...
                                                data-target="#modalGrid" href="javascript:void(0)"
                                                    onclick="addToCart({{ $product->id }})">
                                                    <i class="fa fa-shopping-cart"></i> Add To Cart
                                                </a>
                                            @else
